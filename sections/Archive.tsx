...
interface AssetModalProps {
  asset: { type: string; url: string; label: string; thumbnailUrl?: string } | null;
  onClose: () => void;
}
...
const Archive: React.FC = () => {
  const [selectedAsset, setSelectedAsset] = useState<{ type: string; url: string; label: string; thumbnailUrl?: string } | null>(null);
